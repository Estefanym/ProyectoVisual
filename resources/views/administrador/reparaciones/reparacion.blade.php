            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                   ...
                   <table class="table table table-sm">
                    ...
                    <tr>
                      ...
                      <td>{{$citas->id_tecnico}}</td>
                      <td>{{$citas->id_reparacion}}</td>
                      <td>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{route('citas.edit',$citas->id_cita)}}" name="modificar" class="btn btn-warning" type="submit" style="display:inline-block;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                              </svg></a>
                            <form action="{{route('citas.destroy',$citas->id_cita)}}" method="POST" style="display:inline-block;" onsubmit="return confirm('¿Está seguro?')">
                                @method('delete')
                                @csrf
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <table class="table table table-sm">
                     ...
                     <tr>
                       <td>{{$reparaciones->id_reparacion}}</td>
                       <td>{{$reparaciones->precio}}</td>
                       <td>{{$reparaciones->descripcion}}</td>
                       <td>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{route('reparaciones.edit',$reparaciones->id_reparacion)}}" name="modificar" class="btn btn-warning" type="submit" style="display:inline-block;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                              </svg></a>
                            <form action="{{route('reparaciones.destroy',$reparaciones->id_reparacion)}}" method="POST" style="display:inline-block;" onsubmit="return confirm('¿Está seguro?')">
                                @method('delete')
                                @csrf
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <button name="borrar" class="btn btn-danger" type="submit">
                ...
                <form action="{{route('reparacion.create')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-4 col-m-4 col-lg-4">
                        <label for="Agregar Producto" class="form-label">Id Reparacion</label>
                        <input type="text" class="form-control" name="id_reparacion" placeholder="">
                    </div>           
                    <div class="form-group col-4 col-m-4 col-lg-4">
