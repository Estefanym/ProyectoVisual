...
@section('content')
  ...
  <div class="row justify-content-center">
      <div class="col-lg-7">
          ...
          @else
              <h4 style="color: white">No hay Productos en tu carrito</h4><br>
              <a href="{{ url("/productos") }}" class="btn btn-danger">Continue en la tienda</a>
          @endif

          @foreach($carrito as $item)
              <div class="row">
                  <div class="col-lg-3">
                      <img  src="{{asset($item->imagen)}}" class="img-thumbnail" width="200" height="200">
                  </div>
                  <div class="col-lg-5">
                      <p>
                          <b><a href="/productos">{{ $item->nombre }}</a></b><br>
